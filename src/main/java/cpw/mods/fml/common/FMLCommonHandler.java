...
public class FMLCommonHandler
{
    ...
    public Side getSide()
    {
        if (sidedDelegate == null) return Side.CLIENT;
    ...
    {
        if (sidedDelegate == null) return null;
    ...
    public void handleWorldDataLoad(SaveHandler handler, WorldInfo worldInfo, NBTTagCompound tagCompound)
    {
        ...
        ((IMixinWorldInfo) (Object) worldInfo).setAdditionalProperties(additionalProperties);
        for (ModContainer mc : Loader.instance().getModList())
        {
            if (mc instanceof InjectedModContainer)
            {
