...
import net.xiaoyu233.fml.reload.utils.StringTranslateHelper;
    ...
    private void searchZipForENUSLanguage(File source) throws IOException
    {
        ...
        for (ZipEntry ze : Collections.list(zf.entries()))
        {
            ...
            if (matcher.matches())
            {
                ...
                StringTranslateHelper.inject(zf.getInputStream(ze));
            }
        }
        zf.close();
    }
    private void searchDirForENUSLanguage(File source, String path) throws IOException
    {
        for (File file : source.listFiles())
        {
            ...
            if (matcher.matches())
            {
                ...
                StringTranslateHelper.inject(new FileInputStream(file));
            }
        }
    }
    @Override
