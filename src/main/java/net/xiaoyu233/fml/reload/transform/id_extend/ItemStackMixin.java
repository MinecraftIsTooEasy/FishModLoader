...
//    @Redirect(method = {"<init>(Lnet/minecraft/block/Block;I)V", "<init>(Lnet/minecraft/block/Block;II)V"}, at = @At(value = "FIELD", target = "Lnet/minecraft/block/Block;blockID:I"))
