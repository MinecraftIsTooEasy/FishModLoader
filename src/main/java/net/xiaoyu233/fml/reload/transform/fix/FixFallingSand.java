...
public class FixFallingSand {
    @WrapOperation(method = "canDislodgeOrCrushBlockAt", at = @At(value = "INVOKE", target = "Lnet/minecraft/block/Block;isDislodgedOrCrushedByFallingBlock(ILnet/minecraft/block/Block;I)Z"))
