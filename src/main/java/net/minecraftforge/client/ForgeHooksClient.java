...
public class ForgeHooksClient
{
    ...
    {
        String result = null; // MITE: armor.getItem().getArmorTexture(armor, entity, slot, type) does not exist on Item
    ...
    public static void orientBedCamera(Minecraft mc, EntityLivingBase entity)
    {
        ...
        if (false) // MITE: isBed/getBedDirection not available in Block
        {
    ...
    {
        //TODO add renderingWorldRenderer
//        if (Tessellator.renderingWorldRenderer)
    ...
    {
        ModelBiped modelbiped = null; // MITE: itemStack.getItem().getArmorModel(...) does not exist on Item
