...
public class GuiIngameForge extends GuiIngame
{
    ...
    public void renderGameOverlay(float partialTicks, boolean hasScreen, int mouseX, int mouseY)
    {
        ...
        if (!mc.playerController.enableEverythingIsScrewedUpMode())
        {
            ...
            if (renderBossHealth && !pre(BOSSHEALTH))
            {
    ...
    // renderBossHealth removed - handled inline in renderGameOverlay since parent method is final
    ...
    private void renderHelmet(ScaledResolution res, float partialTicks, boolean hasScreen, int mouseX, int mouseY)
    {
        ...
        if (this.mc.gameSettings.thirdPersonView == 0 && itemstack != null && itemstack.getItem() != null)
        {
            ...
            // renderHelmetOverlay is not available in MITE
            // else
            // {
    ...
    public void renderFood(int width, int height)
    {
        ...
        int levelLast = stats.getNutrition();
        ...
        for (int i = 0; i < 10; ++i)
        {
            ...
            if (mc.thePlayer.getFoodStats().getSatiation() <= 0.0F && updateCounter % (level * 3 + 1) == 0)
            {
    ...
    {
        // MITE handles sleep fade rendering internally in GuiIngame
    }
    ...
    protected void renderExperience(int width, int height)
    {
        ...
        if (mc.playerController.func_78763_f())
        {
            ...
            int cap = this.mc.thePlayer.getExperienceRequired(this.mc.thePlayer.getExperienceLevel());
            int left = width / 2 - 91;
        ...
        if (this.mc.gameSettings.heldItemTooltips)
        {
            ...
            if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null)
            {
                ...
                if (opacity > 0)
                {
                    ...
                    GL11.glEnable(GL11.GL_BLEND);
                    GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
                    // getFontRenderer on Item is not available in MITE, use default
