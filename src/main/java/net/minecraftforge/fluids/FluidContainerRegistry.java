...
public abstract class FluidContainerRegistry
{
    ...
    private static final ItemStack NULL_EMPTYCONTAINER = new ItemStack(Item.bucketIronEmpty);

    static
    {
        registerFluidContainer(FluidRegistry.WATER, new ItemStack(Item.bucketIronWater), EMPTY_BUCKET);
        registerFluidContainer(FluidRegistry.LAVA,  new ItemStack(Item.bucketIronLava),  EMPTY_BUCKET);
    ...
    public static boolean isBucket(ItemStack container)
    {
        ...
        FluidContainerData data = containerFluidMap.get(Arrays.asList(container.itemID, container.getItemDamage()));
        return data != null && ItemStack.areItemStacksEqual(data.emptyContainer, EMPTY_BUCKET);
    }
