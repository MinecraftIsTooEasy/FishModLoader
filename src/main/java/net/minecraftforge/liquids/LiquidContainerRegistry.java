...
public class LiquidContainerRegistry
{
    ...
    public static final ItemStack EMPTY_BUCKET = new ItemStack(Item.bucketIronEmpty);
    ...
    static
    {
        registerLiquid(new LiquidContainerData(new LiquidStack(Block.waterStill, LiquidContainerRegistry.BUCKET_VOLUME), new ItemStack(Item.bucketIronWater), new ItemStack(Item.bucketIronEmpty)));
        registerLiquid(new LiquidContainerData(new LiquidStack(Block.lavaStill, LiquidContainerRegistry.BUCKET_VOLUME),  new ItemStack(Item.bucketIronLava), new ItemStack(Item.bucketIronEmpty)));
    ...
    public static boolean isBucket(ItemStack container)
    {
        ...
        /* MITE: ItemStack.isItemEqual(ItemStack) does not exist */
        if (ItemStack.areItemStacksEqual(container, EMPTY_BUCKET))
        {
            return true;
        }

        LiquidContainerData ret = mapLiquidFromFilledItem.get(Arrays.asList(container.itemID, container.getItemDamage()));
        return ret != null && ItemStack.areItemStacksEqual(ret.container, EMPTY_BUCKET);
    }
