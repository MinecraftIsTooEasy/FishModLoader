...
public class BiomeManager
{
    public static void addVillageBiome(BiomeGenBase biome, boolean canSpawn)
    {
        ...
        // MITE: MapGenVillage.villageSpawnBiomes not available
        if (false)
        {
    ...
    {
        /* MITE: commented out - API not available
        // MITE: MapGenStronghold.allowedBiomes not available
        if (false)
        {
    ...
    {
        /* MITE: commented out - API not available
        // MITE: WorldChunkManager.allowedBiomes not available
        if (false)
        {
