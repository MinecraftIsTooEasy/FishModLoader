...
public class ForgeChunkManager
{
    ...
    static void loadWorld(World world)
    {
        ...
        File chunkDir = ((SaveHandler)worldServer.getSaveHandler()).getWorldDirectory();
        File chunkLoaderData = new File(chunkDir, "forcedchunks.dat");
    ...
    static void saveWorld(World world)
    {
        ...
        for (String modId : ticketSet.keySet())
        {
            ...
            for (Ticket tick : ticketSet.get(modId))
            {
                ...
                {
                    /* MITE: Entity doesn't have chunkCoordX, chunkCoordY, or getPersistentID()
    ...
    {
        /* MITE: Entity doesn't have getPersistentID()
    ...
    public static Chunk fetchDormantChunk(long coords, World world)
    {
        ...
        if (chunk != null)
        {
            /* MITE: Entity doesn't have resetEntityId()
