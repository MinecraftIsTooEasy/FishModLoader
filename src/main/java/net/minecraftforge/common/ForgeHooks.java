...
public class ForgeHooks
{
    ...
    public static void plantGrass(World world, int x, int y, int z)
    {
        ...
        if (grass == null || grass.block == null || true)
        {
            return;
        }
     ...
     * MITE: Disabled - MovingObjectPosition API differs (extends RaycastCollision, no typeOfHit/entityHit/blockX fields)
     */
    public static boolean onPickBlock(MovingObjectPosition target, EntityPlayer player, World world)
    {
        return false;
        /* MITE: Original code commented out due to incompatible MovingObjectPosition API
