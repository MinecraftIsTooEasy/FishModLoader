...
public class ModLoader
{
    ...
    {
        EntityRegistry.addSpawn(entityClass, weightedProb, min, max, spawnList, ((IMixinWorldType) WorldType.DEFAULT).getBase12Biomes());
    }
    ...
    {
        EntityRegistry.addSpawn(entityName, weightedProb, min, max, spawnList, ((IMixinWorldType) WorldType.DEFAULT).getBase12Biomes());
    }
...
//    }
    ...
    {
        EntityRegistry.removeSpawn(entityClass, spawnList, ((IMixinWorldType) WorldType.DEFAULT).getBase12Biomes());
    }
    ...
    {
        EntityRegistry.removeSpawn(entityName, spawnList, ((IMixinWorldType) WorldType.DEFAULT).getBase12Biomes());
    }
    ...
    public static void serverSendPacket(NetServerHandler handler, Packet packet)
    {
        if (handler != null)
        {
            PacketDispatcher.sendPacketToPlayer(packet, (Player) ((IMixinNetHandler) handler).getPlayer());
        }
    }
    @Deprecated
